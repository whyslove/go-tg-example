...
type Server struct {
	...
	httpMathematical *httpMathematical
}
...
func (srv *Server) WithLog(log zerolog.Logger) *Server {
	if srv.httpMathematical != nil {
		srv.httpMathematical = srv.Mathematical().WithLog(log)
	}
	return srv
}
...
func (srv Server) Mathematical() *httpMathematical {
	return srv.httpMathematical
}
